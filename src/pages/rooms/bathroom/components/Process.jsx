  ...
  return (
    <section className="process-section">
      <div className="process-content">
        ...
        <p>
          Our bathroom cleaning process is thorough and tailored to meet the highest
          standards of hygiene and cleanliness.
        </p>
        <br />
        <p>
          <strong>Here&apos;s what we do:</strong>
        </p>
        <ul>
      ...
      <div className="process-image">
        <img alt="Bathroom Cleaning Process" src="assets/bathroom-process.jpg" />
      </div>
    </section>
  );
};
