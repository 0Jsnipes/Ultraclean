    ...
    <section className="duties-section">
      ...
      <div className="duties-content">
        <div className="photo-container" style={{ position: 'relative' }}>
          <img alt="Cleaning Tasks" className="duties-photo" src="/assets/moving-duties.jpg" />
          {showOverlay && (
      ...
      <Link to="/contact">
        <button className="duties-note" type="button">
          Our move-in/out cleaning ensures every nook and cranny is spotless, making your
          move seamless and helping you secure your deposit.
        </button>
      </Link>
    </section>
  );
